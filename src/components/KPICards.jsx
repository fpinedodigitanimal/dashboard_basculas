...
export default function KPICards() {
  ...
  const cards = [
    ...
    },
    {
      ...
      value: kpis.activityTrend >= 0 ? `+${kpis.activityTrend.toFixed(1)}%` : `${kpis.activityTrend.toFixed(1)}%`,
      color: kpis.activityTrend >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400',
      bgColor: kpis.activityTrend >= 0 ? 'bg-green-100 dark:bg-green-900/20' : 'bg-red-100 dark:bg-red-900/20',
      trend: true
    },
    {
      icon: AlertTriangle,
      ...
      color: kpis.scalesWithAlerts > 0 ? 'text-orange-600 dark:text-orange-400' : 'text-gray-600 dark:text-gray-400',
      bgColor: kpis.scalesWithAlerts > 0 ? 'bg-orange-100 dark:bg-orange-900/20' : 'bg-gray-100 dark:bg-gray-900/20'
    }
  ]
